...
export const Carousel = () => {
    ...
    const required =
        'text-lowercase bg-dark text-white text-nowrap py-1 px-2 p-light rounded tooltipText position-relative ms-3'
                    ...
                    <Row>
                        ...
                        <Col lg={{ span: 5, order: 2 }} className='order-1'>
                            ...
                            <p className='mb-4 text-muted'>
                                Est id eiusmod tempor culpa eu magna minim ipsum. Occaecat nostrud
                                nulla ut duis mollit occaecat duis cillum et anim occaecat cupidatat
                                do velit.
                            </p>
                            <Form>
                                <Row>
